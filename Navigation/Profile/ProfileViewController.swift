    ...
    extension ProfileViewController: UITableViewDelegate, UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            if indexPath.section == 0 {
                let cell = tableView.dequeueReusableCell(withIdentifier: "cellPhoto", for: indexPath) as! PhotoesTableViewCell
                return cell
            } else {
        ...
        func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            if indexPath.section == 0 {
                navigationController?.pushViewController(PhotoesViewController(), animated: true)
        ...
        func showPost (author: String, picture: UIImage, description: String, likes: Int, views: Int) {
            let dumbHeader = UILabel()
            dumbHeader.backgroundColor = .white
            ...
            viewLabel.text = "Просмотров: \(views)"
            ...
            postView.addSubview(dumbHeader)
            ...
            NSLayoutConstraint.activate([
                ...
                dumbHeader.topAnchor.constraint(equalTo: view.topAnchor),
                dumbHeader.widthAnchor.constraint(equalTo: view.widthAnchor),
                dumbHeader.heightAnchor.constraint(equalToConstant: 200),
